...
namespace osu.Game.Rulesets.Osu.Mods
{
    ...
    {
        [SettingSource(typeof(OsuModHiddenStrings), nameof(OsuModHiddenStrings.OnlyFadeApproachCircles), nameof(OsuModHiddenStrings.TheMainObjectBodyWill))]
        public Bindable<bool> OnlyFadeApproachCircles { get; } = new BindableBool();

        public override LocalisableString Description => OsuModHiddenStrings.PlayWithNoApproachCircles;

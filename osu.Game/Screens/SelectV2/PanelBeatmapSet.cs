    ...
    public partial class PanelBeatmapSet : Panel
    {
        ...
        public override MenuItem[] ContextMenuItems
        {
            get
            {
                ...
                if (!Expanded.Value)
                {
                    items.Add(new OsuMenuItem(PanelBeatmapSetStrings.Expand, MenuItemType.Highlighted, () => TriggerClick()));
                    items.Add(new OsuMenuItemSpacer());
                }

                if (beatmapSet.OnlineID > 0)
                {
                    items.Add(new OsuMenuItem(PanelBeatmapSetStrings.Details, MenuItemType.Standard, () => beatmapOverlay?.FetchAndShowBeatmapSet(beatmapSet.OnlineID)));
                ...
                if (manageCollectionsDialog != null)
                    collectionItems.Add(new OsuMenuItem(PanelBeatmapSetStrings.Manage, MenuItemType.Standard, manageCollectionsDialog.Show));

                items.Add(new OsuMenuItem(PanelBeatmapSetStrings.Collections) { Items = collectionItems });

                if (beatmapSet.Beatmaps.Any(b => b.Hidden))
                    items.Add(new OsuMenuItem(PanelBeatmapSetStrings.RestoreAllHidden, MenuItemType.Standard, () => songSelect?.RestoreAllHidden(beatmapSet)));

                items.Add(new OsuMenuItem(PanelBeatmapSetStrings.Delete, MenuItemType.Destructive, () => songSelect?.Delete(beatmapSet)));
